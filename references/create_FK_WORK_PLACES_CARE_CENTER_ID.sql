 ...
 * */
ALTER TABLE APP_HIST_CLINICA.work_places ADD CONSTRAINT fk_work_places_care_center_id FOREIGN KEY (care_center_id) REFERENCES care_centers(care_center_id);