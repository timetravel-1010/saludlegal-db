 ...
 * */
ALTER TABLE APP_HIST_CLINICA.healthcare_professionals ADD CONSTRAINT fk_healthcare_professionals_specialty_id FOREIGN KEY (specialty_id) REFERENCES specialties(specialty_id);