 ...
 * */
ALTER TABLE APP_HIST_CLINICA.medical_records ADD CONSTRAINT fk_medical_records_patient_id FOREIGN KEY (patient_id) REFERENCES APP_HIST_CLINICA.patients(patient_id);
